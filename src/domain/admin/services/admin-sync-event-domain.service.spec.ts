...
import { AdminSyncEventDomainService } from './admin-sync-event-domain.service';
import {
  SYNC_EVENT_REPOSITORY,
  ISyncEventRepository,
} from '../../sync-event/repositories/sync-event.repository.interface';
import {
  SyncEventEntity,
  SyncEventStatus,
  SyncEventType,
...
describe('AdminSyncEventDomainService', () => {
  let service: AdminSyncEventDomainService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<AdminSyncEventDomainService>(AdminSyncEventDomainService);
  });
