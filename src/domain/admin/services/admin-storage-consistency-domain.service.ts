...
import {
  CACHE_STORAGE_PORT,
} from '../../storage/ports/cache-storage.port';
import {
  NAS_STORAGE_PORT,
} from '../../storage/ports/nas-storage.port';
import {
  StorageType,
  FileStorageObjectEntity,
} from '../../storage/file/file-storage-object.entity';
import type { IFileStorageObjectRepository } from '../../file/repositories/file.repository.interface';
import type { IFileRepository } from '../../file/repositories/file.repository.interface';
import type { ICacheStoragePort } from '../../storage/ports/cache-storage.port';
import type { INasStoragePort } from '../../storage/ports/nas-storage.port';
...
@Injectable()
export class AdminStorageConsistencyDomainService {
  private readonly logger = new Logger(AdminStorageConsistencyDomainService.name);
