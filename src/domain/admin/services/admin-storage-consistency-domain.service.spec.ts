...
import { AdminStorageConsistencyDomainService } from './admin-storage-consistency-domain.service';
import {
...
import { FileEntity, FileState } from '../../file/entities/file.entity';

describe('AdminStorageConsistencyDomainService', () => {
  let service: AdminStorageConsistencyDomainService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<AdminStorageConsistencyDomainService>(
      AdminStorageConsistencyDomainService,
    );
  });
